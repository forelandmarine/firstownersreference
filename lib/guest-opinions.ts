  ...
  "09-decision-framework": [
    {
      ...
      intro:
        "Quadrant Group is a corporate services provider headquartered in the Isle of Man, with offices in Jersey, Malta, and Palma and forty years in the marine sector; it designs and administers yacht ownership structures. Quadrant provides the ownership-structure services this chapter discusses, and the independence test above applies to it as to any firm. We put seven questions to Simon Roberts on the ownership-structure decision, jurisdiction, VAT and importation, private against commercial use, the running cost of the structure, the independence test applied to his own firm, and the decision hardest to reverse. His answers are published as given, lightly edited for typography and house style.",
      questions: [
        {
          question:
        ...
        },
        {
          ...
          answer: [
            ...
            "For first-time owners, the terminology can understandably feel daunting, but the underlying principle is straightforward. The objective should never be to create the most sophisticated ownership structure or the most elaborate VAT solution. It should be to establish a framework that supports the owner's intended use of the yacht while providing clarity and certainty from the outset. When those decisions are made together and early enough in the process, owners are far more likely to avoid unnecessary cost, delay and future restructuring.",
          ],
        },
        {
          question:
