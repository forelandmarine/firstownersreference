...
export const printImages: {
  ...
  plates: {
    "01-reality-of-ownership": [
      ...
      { filename: "aleksandr-skvortsov-ykSc4VaRtBQ-unsplash.jpg", alt: "Chapter 01 plate" },
      { filename: "aristos-aristidou-Rj3gpDWNnAQ-unsplash.jpg", alt: "Chapter 01 plate" },
    ],
    "02-reading-the-market": [
      ...
      { filename: "alexander-mils-l4-oK4lbKQ0-unsplash.jpg", alt: "Chapter 02 plate" },
      { filename: "armin-pfarr-lXwXqgIUFTg-unsplash.jpg", alt: "Chapter 02 plate" },
    ],
    "03-how-the-industry-works": [
      ...
      { filename: "alexandros-giannakakis-kGdAphiYwy4-unsplash.jpg", alt: "Chapter 03 plate" },
      { filename: "arno-senoner-1q7RE0CXstU-unsplash.jpg", alt: "Chapter 03 plate" },
    ],
    "04-acquisition-process": [
      ...
      { filename: "alexandros-giannakakis-z5lGREDnrCY-unsplash.jpg", alt: "Chapter 04 plate" },
      { filename: "arno-senoner-iOmFn_anJvA-unsplash.jpg", alt: "Chapter 04 plate" },
    ],
    "05-new-build-versus-brokerage": [
      ...
      { filename: "alexandros-sarakasidis-iXUx8yyE8J0-unsplash.jpg", alt: "Chapter 05 plate" },
      { filename: "arno-senoner-loU_6fwdPRc-unsplash.jpg", alt: "Chapter 05 plate" },
    ],
    "06-refit": [
      ...
      { filename: "amit-adler-o-GUkfq0tlE-unsplash.jpg", alt: "Chapter 06 plate" },
      { filename: "atul-ajit-Lvr-U5Bpdqs-unsplash.jpg", alt: "Chapter 06 plate" },
    ],
    "07-operations": [
      ...
      { filename: "andras-joo-5LK8T0pjPZc-unsplash.jpg", alt: "Chapter 07 plate" },
      { filename: "ben-elliott-qdrmRHrCmTk-unsplash.jpg", alt: "Chapter 07 plate" },
    ],
    "08-motor-versus-sail": [
      ...
      { filename: "andre-tan-4DRfdkajOq8-unsplash.jpg", alt: "Chapter 08 plate" },
      { filename: "boris-misevic-ZUlV60gfNJI-unsplash.jpg", alt: "Chapter 08 plate" },
    ],
    "09-decision-framework": [
      ...
      { filename: "andrea-zignin-Us8dszDXx28-unsplash.jpg", alt: "Chapter 09 plate" },
      { filename: "boris-misevic-q_8cRkqTWNk-unsplash.jpg", alt: "Chapter 09 plate" },
    ],
  },
