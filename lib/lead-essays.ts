...
export const leadEssays: Record<string, LeadEssay> = {
  ...
  "05-new-build-versus-brokerage": {
    ...
    paragraphs: [
      ...
      "The commercial case is therefore not \"it costs more but it's worth it for the customisation.\" It is that for a buyer with a 7 to 10 year hold horizon, a use pattern that depends on bespoke specification, and a competent representation team, new build is sometimes the lower total cost over the hold period despite the higher headline price. Without those three conditions, new build is much worse.",
