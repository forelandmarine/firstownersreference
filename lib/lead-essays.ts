...
export const leadEssays: Record<string, LeadEssay> = {
  ...
  "08-motor-versus-sail": {
    ...
    paragraphs: [
      ...
      "Depreciation. Quality sailing yachts hold value much better than comparable motor yachts in the 30 to 50m band (broker-aggregated data). Top sailing builders (Royal Huisman, Vitters, Baltic, Perini Navi) show single-digit annual depreciation after year five, against 5 to 8 percent for top motor builders. Across a seven-year hold a 35m sailing programme runs 25 to 40 percent below the equivalent motor on total cost (capex plus opex minus residual). Brokers do not present this comparison because the two segments are sold by different desks.",
