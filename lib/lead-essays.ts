...
export const leadEssays: Record<string, LeadEssay> = {
  ...
  "09-decision-framework": {
    ...
    paragraphs: [
      ...
      { type: "h2", text: "The structure the team is hired to build" },
      "The team exists to build and protect a structure. That structure, personal ownership, a company, or something more layered, together with the jurisdiction it sits in and the VAT position that rides on it, is its own decision, and one taken earliest of all. Quadrant Group, a corporate services provider that has advised marine clients from the Isle of Man for forty years, provides exactly these services, so the independence test above applies to it as it does to any firm. Simon Roberts sets out how the decision is made, and how early it has to be, in the interview that follows this essay. His central point is that the structure should be built around what the owner intends to do with the yacht, and that the costly errors come not from the wrong structure but from the right questions asked too late.",
      {
        type: "blockquote",
        text: "An Isle of Man structure may suit around a quarter of purchases, depending on the circumstances.",
