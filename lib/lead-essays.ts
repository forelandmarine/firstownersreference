...
export const leadEssays: Record<string, LeadEssay> = {
  "01-reality-of-ownership": {
    ...
    paragraphs: [
      ...
      "The honest position: budget 12 to 15 percent for a typical 40m to 50m new build operated privately at moderate use, and revise upward for charter operation, larger size, or older age. Do not let any party paid contingent on a deal closing tell you otherwise.",
      ...
      {
        type: "blockquote",
        text: "The folklore of the 10 percent rule survives because it is roughly correct for new, mid-sized, lightly used yachts. It is wrong for most readers of The First Owner’s Reference.",
      },
      ...
      "Quality builders hold value materially better. Feadship, Lurssen, Royal Huisman, Vitters, and Baltic Yachts hulls can lose only single-digit percentages annually after year five. There is no peer-reviewed academic study of yacht depreciation; all published curves are broker-aggregated and self-reported, which is itself a finding.",
  ...
  "02-reading-the-market": {
    ...
    paragraphs: [
      ...
      "41 percent of new UHNWIs were created in the United States, and the country's share of the global UHNW population is forecast to reach 41 percent by 2031, up from 33 percent in 2021; the concentration is still intensifying. Saudi Arabia leads billionaire growth at a forecast 183 percent over five years, Indonesia leads UHNWI growth at 82 percent, and India is forecast to add UHNWIs faster in absolute terms than any other economy.",
      ...
      "The breakdown by hull type from BoatPro: 837 motor, 101 explorer, 69 sailing, 63 open, 23 sportfish. Explorer has consolidated as the second-largest single category at roughly nine percent of the order book, the structural shift least covered in trade press.",
      ...
      "The motive question sits underneath the data, and is rarely answered well in trade press. Robb Maass of Alley, Maass, Rogers & Lindsay, on the published record in March 2026:",
      {
        type: "blockquote",
  ...
  "05-new-build-versus-brokerage": {
    ...
    paragraphs: [
      "The financial and operational consequences diverge sharply over the next decade.",
      ...
      { type: "h2", text: "Yards going under, owners holding the bag" },
      "A separate pattern, less covered in trade press, has emerged over the past five years: a yard runs into financial difficulty mid-build, and the owner is presented with a choice that is not really a choice. Inject additional capital, sometimes as equity in the restructured business, or face the yacht stalling, the supplier chain freezing, and the work-in-progress becoming an asset of the insolvency.",
  ...
  "06-refit": {
    ...
    paragraphs: [
      ...
      "The 30 to 50 percent overrun is the empirical expectation against an initial scope built on imperfect information, not really a project management failure. A yard quote based on visual inspection cannot anticipate everything that will be found when the deck is opened, the engine room stripped, or the bilges scrubbed. The question is not whether the refit will run over, but by how much, and whether the contract and owner-side representation contain it within reason.",
  ...
  "07-operations": {
    ...
    paragraphs: [
      ...
      "United States. Regulated under federal law (Coastguard / Jones Act). Foreign-flagged yachts cannot embark and disembark passengers between US ports under standard charter; this materially restricts non-US-flagged commercial operation in US waters.",
  ...
  "08-motor-versus-sail": {
    ...
    paragraphs: [
      ...
      "The methane line added from 2026 matters most for LNG-fuelled vessels where methane slip is significant. For diesel-fuelled engines and diesel hotel-load generators on most yachts, methane emissions are negligible; the practical taxation effect remains on CO2.",
  ...
  "09-decision-framework": {
    ...
    paragraphs: [
      ...
      "These six questions apply to anyone proposing to advise, and serve as the rough framework for due diligence on a wealth manager, a lawyer, a surveyor, or a captain candidate. The principles are fiduciary alignment applied to an industry that has structurally avoided them; they are not really yacht-specific.",
      { type: "h2", text: "The suitability test" },
      "This is a separate test from the independence test. Where the independence test asks whether a firm is structurally aligned with the buyer, the suitability test asks whether the firm is the right fit for this engagement. A firm can pass the independence test and still be the wrong choice for a given project. Six elements.",
