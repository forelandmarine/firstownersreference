...
export const leadEssays: Record<string, LeadEssay> = {
  "01-reality-of-ownership": {
    ...
    paragraphs: [
      ...
      "Quality builders hold value much better. Feadship, Lürssen, Royal Huisman, Vitters, and Baltic Yachts hulls can lose only single-digit percentages annually after year five. There is no peer-reviewed academic study of yacht depreciation; all published curves are broker-aggregated and self-reported, which is itself a finding.",
      "The yacht is not an investment. It is a depreciating asset whose depreciation is roughly the same magnitude as the annual operating cost in the early years. A USD 30 million yacht held for five years at moderate use will typically have lost USD 12 to 15 million in value and consumed another USD 15 to 22 million in opex. An eight-figure hold cost over the period is the realistic frame.",
  ...
  "02-reading-the-market": {
    ...
    paragraphs: [
      ...
      "Second, supply is concentrated at Italian volume yards (Azimut Benetti, Sanlorenzo) for unit count and Northern European custom yards (Lürssen, Feadship, Oceanco) for prestige and value retention. The prestige tier is sold out for several years. A first-time buyer in 2026 cannot have a 50m Lürssen by 2027. The decision is between a 2030 Lürssen, a 2027 Heesen, or a brokerage hull available now.",
  ...
  "04-acquisition-process": {
    ...
    paragraphs: [
      ...
      "Boat shows are part of the visit phase, not the closing phase, and brokers say so on the record. Will Christie at the Palm Beach show in March 2026:",
      {
        type: "blockquote",
        ...
        attribution: "Will Christie, Palm Beach International Boat Show, March 2026 (Superyacht Investor)",
      },
      ...
      "They are also not separate from each other. The VAT regime, the flag, and the ownership structure the yacht sits inside are one decision with three parts, and settling them together before contracts are exchanged is far cheaper than unpicking them afterwards, when the exposure can be a liability calculated on the value of the yacht. Simon Roberts of Quadrant Group sets out that sequencing, and how early it has to happen, in chapter nine.",
      "Value-added tax (VAT) regime. The default is full VAT on purchase: 20 percent in France, 21 percent in Spain, 22 percent in Italy. On a EUR 4 million yacht the bill is EUR 800,000 to EUR 880,000. Three legitimate alternatives reduce or eliminate this.",
      "The French Commercial Exemption (FCE) eliminates VAT entirely if six conditions are met (commercial registration, full-time crew, length above 15 metres, more than 70 percent of voyages exiting French waters, less than 50 percent static charters). Spanish Inward Processing Relief suspends 21 percent VAT on refit works for non-EU flagged yachts within an 18-month admission window. The Maltese leasing scheme reduces effective VAT to 5.4 to 6.12 percent on yachts over 24 metres. Italian leasing has been largely curtailed by EU infringement proceedings.",
      ...
      "The technical baseline is the yacht code. The UK MCA Code of Practice for the Safety of Large Commercial Sailing and Motor Vessels (LY1, 1997) was rebranded as the Red Ensign Group (REG) Yacht Code in 2017 after successive revisions. Malta published its first national yacht code in 2006; the Marshall Islands followed in 2013. All three have been updated within the last two years to incorporate SOLAS Alternative Design and Arrangements (ADAs), the route by which innovative designs and alternative fuels (methanol, hydrogen, hybrid configurations) reach certification. Phil Noad of Cayman Registry argues that a harmonised IMO yacht code would not serve the segment; the dynamic competition between national yacht codes is what allows new technology to reach delivery ahead of IMO timelines. The recently formed Yacht Safety and Environmental Consortium (YSEC), under the International Association of Classification Societies (IACS), is the likely vehicle for cross-flag standardisation of base rules without erasing competitive variation (Phil Noad, in The Superyacht Report, Q2 2026).",
      "A separate UK-specific jurisdictional risk sits on top of the technical choice. The 60-metre Royal Huisman motoryacht Phi has been detained on the Thames in London since 2022 on a UK Department for Transport direction, issued shortly after the Russian invasion of Ukraine. The owner, Sergei Naumenko, has not been sanctioned by any state and has no proven political influence in Russia; the detention has outlived the Transport Secretary who issued it, multiple governments, and several legal challenges. The UK Supreme Court ruled against Phi’s appeal in summer 2025; the case now sits at the European Court of Human Rights, with a separately-granted British court permission to pursue damages against the UK Treasury for an undisclosed but significant quantum. The narrow point for a buyer weighing a Red Ensign flag for a UK-domiciled hull is that the British executive has acted, and can act, on yachts whose owners do not match the public profile of a sanctioned individual; remedy through the British court system can take years (Capt. Guy Booth, in The Superyacht Report, Q2 2026).",
  ...
  "05-new-build-versus-brokerage": {
    ...
    paragraphs: [
      ...
      {
        type: "blockquote",
        text: "Between a broker and an owner’s representative, they are different disciplines. The best projects usually happen when everyone brings their expertise to the table, with clear roles and alignment around the owner.",
        attribution: "Jack Inglis, founder, ULTIMAR, May 2026",
      },
  ...
  "06-refit": {
    ...
    paragraphs: [
      ...
      "MB92 Group. Barcelona plus La Ciotat (Compositeworks and Monaco Marine Golfe-Juan). Owns paint specialist GYG (parent of Pinmar). The dominant full-service Western Mediterranean operator. CEO Pepe García-Aubert. Squircle Capital, majority shareholder since 2019, reached 100 percent ownership in March 2026.",
      ...
      "Bl\u00e4sing Yacht Service / Lürssen Refit. German full-service refit for the largest yachts.",
  ...
  "07-operations": {
    ...
    paragraphs: [
      ...
      "The pay differential between a good captain and a competent average one is small; the operational differential is large. YPI Crew’s 2026 salary guide places captain pay on a 50 to 60 metre yacht at EUR 10,000 to 16,000 per month. Quay Crew records average pay from EUR 6,000 on a 20 to 24m yacht to over EUR 25,000 on a 100 to 119m vessel; the 70 to 79m bracket saw a 7 percent increase on the previous survey year, and 63 percent of captains are now on time-for-time rotation.",
      ...
      "The Bayesian sinking in August 2024 (USD 150 million insured loss) prompted speculation of a fresh hardening cycle. Pantaenius’s Michelle van der Merwe, on the record: “I think everyone thought it was going to have more of an impact than it did.” Davis confirms the read from the broker side: no significant rating increases across PIB’s large-sailing-yacht book, the Bayesian hull a multiply-built Perini design with a one-off rig configuration. The market response visible at policy level sits at survey level, not rate level.",
      {
        ...
        attribution: "Ollie Davis, PIB Marine, May 2026",
      },
      ...
      {
        type: "blockquote",
        text: "Ironically, War Risks cover does not provide cover for you while you are in designated War Risk areas, which is something that is often misunderstood.",
        attribution: "Ollie Davis, PIB Marine, May 2026",
      },
      ...
      "Spain. Separate Spanish charter licence (“matrícula turística” / Royal Decree 1027/1989) for non-EU-flagged yachts; application before each season; 4 percent matriculation tax on declared value (capped for yachts above 15m registered for charter).",
  ...
  "08-motor-versus-sail": {
    ...
    paragraphs: [
      ...
      "EU ETS Maritime is the most consequential. In force from 1 January 2024, it covers ships above 5,000 GT calling at EEA ports. Compliance is phased by emissions year: 40 percent of 2024 emissions (surrendered in 2025), 70 percent of 2025 emissions, and 100 percent of 2026 emissions onward. Most yachts sit below 5,000 GT (a 60m motor yacht is typically 700 to 1,200 GT); the bite lands on the very large motors above the threshold, around EUR 200,000 to 400,000 per year on a 90m at current carbon prices. Comparable sailing yachts pay much less.",
      ...
      "A third reference point sits at the wind-and-solar end of the spectrum. Captain Arctic, a 70 metre expedition yacht due for delivery in 2026 by French outfit Selar at Chantier Naval de l’Ocean Indien in Mauritius and chartered through Pelorus Yachting, carries five 35 metre rigid solar sails with close to 2,000 square metres of photovoltaic panels, electric propulsion that doubles as hydro-generation under sail, and Bureau Veritas certification of a 90 percent CO2 reduction against comparable vessels. The cruising programme is Norway, Svalbard, and Greenland; the captain is Sophie Galvagnon, with seventeen years in the Arctic as captain and ice pilot. The yacht does not occupy the same operational envelope as a conventional motor at the same length; it sits at the new edge of the hybrid path, closer in profile to Royal Huisman’s AERA concept than to the Heesen FDHF programme (Gayle Patterson, Pelorus Yachting, in The Superyacht Report, Q2 2026).",
  ...
  "09-decision-framework": {
    ...
    paragraphs: [
      ...
      "3. Surveyor. Engaged on a per-deal basis once a shortlist exists. Independent of the broker. Recognised firms include Ward & McKenzie and Patton Marine. The surveyor’s report is paid for by the buyer.",
    ...
    closingNote: [
      ...
      "The single most important decision is to engage an adviser whose interests are aligned with the buyer’s, before engaging anyone aligned with someone else’s. That is the argument. The rest is detail.",
