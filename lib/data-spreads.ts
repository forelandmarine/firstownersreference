    ...
    blocks: [
      ...
      { type: "h2", text: "Brokerage ownership concentration" },
      {
        ...
        rows: [
          ...
          { label: "Burgess", value: "Ancient (PE, founded 2021) acquired strategic stake November 2025" },
      ...
      { type: "h2", text: "Retrocession economy, indicative magnitudes" },
      {
        ...
        rows: [
          ...
          ["Insurance broker introduction", "EUR 250 k premium", "EUR 3,750 to 25,000 a year, depending on whether the referral is set against commission or premium"],
        ],
        sourceLine:
    ...
    blocks: [
      ...
      { type: "h2", text: "Flag state, dominant choices for 30 m+" },
      {
        ...
        rows: [
          ...
          { label: "Red Ensign Group (UK, IoM, Bermuda, Cayman, Jersey, Guernsey, BVI, Gibraltar, Anguilla, Montserrat, Turks and Caicos, Falkland Islands, St Helena)", value: "Common-law jurisdictions; British consular protection" },
        ],
      ...
      { type: "h2", text: "Pre-purchase survey scope, indicative" },
      {
        ...
        rows: [
          ...
          { label: "Recognised firms", value: "Ward & McKenzie, Patton Marine" },
        ],
    ...
    blocks: [
      ...
      { type: "h2", text: "Building the team, in priority order" },
      {
        ...
        rows: [
          ...
          ["3", "Surveyor", "Per-deal once a shortlist exists; Ward & McKenzie, Patton Marine"],
