...
export const chapterFaqs: Record<string, FaqItem[]> = {
  ...
  "06-refit": [
    ...
    },
    {
      ...
      answer:
        "Northern European refit specialists include Pendennis (Falmouth), Damen Vlissingen, Royal Huisman (Vollenhove), Lürssen Bremen, and Amico (Genoa). Mediterranean refit yards include MB92 Group (Barcelona and La Ciotat), STP and Astilleros de Mallorca (Palma), Lusben (Viareggio), and Compositeworks (Marseille). Yard slot booking 12 to 18 months ahead is now standard given top-yard demand. Selection is on track record, alignment, and project manager experience, not cheapest quote.",
    },
    {
